<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      />
      <el-input
        v-model="listQuery.product_code"
        placeholder="产品货号"
        style="width: 200px"
        class="filter-item"
        @keyup.enter.native="handleFilter"
    ...
    >
      ...
      <el-table-column
        ...
        width="150px"
        align="center"
        :class-name="getSortClass('timestamp')"
      >
      ...
      <el-table-column label="单位" align="center" width="95">
        <template slot-scope="{ row }">
          <el-tag :type="row.product_unit | statusFilter">
            {{ row.product_unit }}
          </el-tag>
        </template>
      </el-table-column>
      <el-table-column label="含量" class-name="status-col" width="100">
        <template slot-scope="{ row }">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="货号" prop="product_code">
          <el-input v-model="temp.product_code" />
        </el-form-item>
        ...
        <el-form-item label="数量" prop="content">
          <el-input v-model="temp.content" type="number" />
        </el-form-item>
        <el-form-item label="单位" prop="product_unit">
          <el-select
            v-model="temp.product_unit"
            class="filter-item"
  ...
  data() {
    return {
      ...
      listQuery: {
        ...
        sort: "-timestamp", //默认排序方式
      },
      sortOptions: [
        { label: "按时间升序", key: "+timestamp" },
        { label: "按时间降序", key: "-timestamp" },
      ],
      statusOptions: ["箱", "件", "批"], //添加新的产品时，下拉单位选择框选项
      temp: {
        //初始化添加新产品时的默认选项
        id: undefined,
        product_name: "",
